...
public class Convert2ComplementController implements Initializable {
    private String answer;
    private int question = Integer.MIN_VALUE;

    private static final Random RNG = new Random();
    private static final int[] LEVEL = {8, 128, 128 * 256, 999999};
...
//        this.txtResult.setText(this.answer);
    }
